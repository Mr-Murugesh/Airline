...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.php" class="logo me-auto"><img src="https://i.pinimg.com/736x/d1/45/fd/d145fddf1e794664c56dd4db2271e1ab.jpg" alt="" class="n3VNCb KAlRDb"></a>
...
function formValidation() {
  ...
  <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy;<strong>Airline Management system</strong>
      </div>
    </div>
  </footer>
