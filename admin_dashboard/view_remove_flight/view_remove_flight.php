...
// ** NOTE: This file displays the list of all flights present in the database in the form of
// a table and also let's the admin remove(delete permanently) a flight from the database
